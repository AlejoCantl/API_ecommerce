...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://ecommerce-ten-tau-35.vercel.app",
        "http://localhost:3000",
        "http://127.0.0.1:3000"
    ],
    allow_methods=["*"],
    allow_headers=["*"],
    expose_headers=["*"],  # Para que el frontend pueda leer headers personalizados
    allow_credentials=True,  # Si usas cookies/tokens de autenticación
